...
public class InputWordsActivity extends BRActivity {
    ...
    private String getPhrase() {
        ...
        String w1 = word1.getText().toString().toLowerCase(Locale.getDefault());
        String w2 = word2.getText().toString().toLowerCase(Locale.getDefault());
        String w3 = word3.getText().toString().toLowerCase(Locale.getDefault());
        String w4 = word4.getText().toString().toLowerCase(Locale.getDefault());
        String w5 = word5.getText().toString().toLowerCase(Locale.getDefault());
        String w6 = word6.getText().toString().toLowerCase(Locale.getDefault());
        String w7 = word7.getText().toString().toLowerCase(Locale.getDefault());
        String w8 = word8.getText().toString().toLowerCase(Locale.getDefault());
        String w9 = word9.getText().toString().toLowerCase(Locale.getDefault());
        String w10 = word10.getText().toString().toLowerCase(Locale.getDefault());
        String w11 = word11.getText().toString().toLowerCase(Locale.getDefault());
        String w12 = word12.getText().toString().toLowerCase(Locale.getDefault());
