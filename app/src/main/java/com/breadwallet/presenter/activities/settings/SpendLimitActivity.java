...
public class SpendLimitActivity extends BRActivity {
    ...
    private void updateText(int progress) {
        ...
        BigDecimal amount = BRExchange.getAmountFromSatoshis(this, "ZEON", satoshis);
        ...
        String string = String.format("%s (%s)", BRCurrency.getFormattedCurrencyString(this, "ZEON", amount), BRCurrency.getFormattedCurrencyString(this, iso, curAmount));
    ...
    private BigDecimal getAmountBySte(int step) {
        ...
        switch (step) {
            case 0:
                result = new BigDecimal(ONE_BITCOIN * 500.0);//   500 ZEON
                break;
            case 1:
                result = new BigDecimal(ONE_BITCOIN * 1000.0);//   1000 ZEON
                break;
            case 2:
                result = new BigDecimal(ONE_BITCOIN * 5000.0);//   5000 ZEON
                break;
            case 3:
                result = new BigDecimal(ONE_BITCOIN * 10000.0);//   10000 ZEON
                break;

            default:
                result = new BigDecimal(ONE_BITCOIN * 500.0);//   500 ZEON Default
                break;
        }
        return result;
    }
